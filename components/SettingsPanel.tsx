        ...
        <div className="space-y-5">
          <Field label="Level">
            <select
              ...
              onChange={(e) => {
                const level = e.target.value as PracticeSettings["level"];
                patch({ level, voiceSpeed: defaultVoiceSpeedForLevel(level) });
              }}
            >
            ...
            <p className="mt-1.5 text-xs text-[var(--muted)]">
              Higher levels use denser local Spanish and a slightly faster voice. You can still tweak
              speed below.
            </p>
          </Field>
